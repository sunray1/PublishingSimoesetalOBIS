...
```{r sampleSizeValue, eval=FALSE, include=FALSE}
occurrence <- occurrence %>%
  mutate(sampleSizeValue = case_when(
    CleanedData.Sample_name == "B00"  ~ NULL,
    CleanedData.Sample_name == "B01"  ~ NULL,
    CleanedData.Sample_name == "B02"  ~ NULL,
    CleanedData.Sample_name == "B03"  ~ NULL,
    CleanedData.Sample_name == "B04"  ~ NULL,
    CleanedData.Sample_name == "B05"  ~ NULL,
    CleanedData.Sample_name == "B06"  ~ NULL,
    CleanedData.Sample_name == "B07"  ~ NULL,
    CleanedData.Sample_name == "B08"  ~ NULL,
    CleanedData.Sample_name == "B09"  ~ NULL,
    CleanedData.Sample_name == "B10"  ~ NULL,
    CleanedData.Sample_name == "B11"  ~ NULL,
    CleanedData.Sample_name == "GM01" ~ NULL,
    CleanedData.Sample_name == "GM02" ~ NULL,
    CleanedData.Sample_name == "GM03" ~ NULL,
    CleanedData.Sample_name == "GM04" ~ NULL,
    CleanedData.Sample_name == "GM05" ~ NULL,
    CleanedData.Sample_name == "GM06" ~ NULL,
    CleanedData.Sample_name == "GM07" ~ NULL,
    CleanedData.Sample_name == "GM08" ~ NULL,
    CleanedData.Sample_name == "GM09" ~ NULL,
    CleanedData.Sample_name == "GM10" ~ NULL,
    CleanedData.Sample_name == "GM11" ~ NULL,
    CleanedData.Sample_name == "GM13" ~ NULL,
    CleanedData.Sample_name == "GM14" ~ NULL,
    CleanedData.Sample_name == "GM15" ~ NULL,
    CleanedData.Sample_name == "GM16" ~ NULL,
    CleanedData.Sample_name == "GM18" ~ NULL,
    CleanedData.Sample_name == "GM19" ~ NULL,
    CleanedData.Sample_name == "GM20" ~ NULL,
    CleanedData.Sample_name == "GM21" ~ NULL,
    CleanedData.Sample_name == "GM22" ~ NULL,
    CleanedData.Sample_name == "RM01" ~ NULL,
    CleanedData.Sample_name == "RM02" ~ NULL,
    CleanedData.Sample_name == "RM05" ~ NULL
  ))
```
...
## DNA Derived Data Mapping

```{r DNA_sequence, eval=FALSE, include=FALSE}
DNA_sequence <- NULL
dna_derived_data %<>% mutate(DNA_sequence)
```
